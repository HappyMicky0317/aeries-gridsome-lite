<template lang="pug">
section#aeriesAcademyFAQSection(class="px-2 sm:px-8 mb-32")
      ...
      div(class="md:col-span-4 md:col-start-2 divide-y-2 divide-neutral-400")  
        accordion(
          ...
          .content(slot="content" class="grid grid-cols-1 md:grid-cols-1 gap-4")
            ...
            .content-text(v-html="item.description") 
</template>
...
import AeriesAcademyFAQ from '~/data/aeries-academy-faq.json'
export default {
  data() {
    return {
      faqs: AeriesAcademyFAQ
    }
  },
  methods: {
