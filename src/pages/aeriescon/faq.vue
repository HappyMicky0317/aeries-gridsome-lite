...
Layout(navStyle="dark", sub-nav, :sub-nav-config="subNavConfig")
  ...
  section.container.text-neutral-1300.mt-36.mb-12
    .section-title.w-full.text-center.mt-8.-mb-16.text-neutral-1800(
      class="md:mt-16 md:-mb-24"
    )
      h1.font-aeries.text-header.font-bold.mb-12(class="md:text-xx-large") AeriesCon FAQs
    
  section.text-neutral-1300.mt-36.mb-24
      AeriesConFAQSectionS23
